...
from openagent.audit.log.busi_logger import BusiLogger, init_busi_logger
from openagent.audit.log.dto import BusiLog
from openagent.audit.log.log_context import bind_request_context, clear_request_context
from openagent.audit.log.object_log_writer import ObjectLogWriter
from openagent.audit.log.request_logger import RequestLogger, init_request_logger
from openagent.audit.log.sys_logger import SysLogger, init_sys_logger
...
def test_busi_logger_type_prefix():
    b = init_busi_logger("openagent")
    assert b.type_prefix == "BUSI_LOG_OPENAGENT"
...
def test_request_logger_type_prefix():
    r = init_request_logger("openagent")
    assert r.type_prefix == "REQUEST_LOG_OPENAGENT"
...
def test_request_logger_start_end():
    ...
    assert start["type"] == "REQUEST_LOG_OPENAGENT"
