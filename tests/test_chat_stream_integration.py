        ...
        ctx=SimpleNamespace(
            scenario=SimpleNamespace(
                workspace=SimpleNamespace(
                    workspace_dirs=["/app/work/tenants/tenant-A/projects/project-1"],
                ),
            ),
        ),
    )

    assert _resolve_session_directory(request) == "/mnt/c/WorkSpace/Coding/OpenAgent/work/tenant-A/project-1"
