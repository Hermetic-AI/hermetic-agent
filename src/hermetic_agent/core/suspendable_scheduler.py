...
from hermetic_agent.core._hitl_defs import ASK_USER_TOOL, build_default_card_input
...
from hermetic_agent.skills.runtime.manifest import SkillManifest
...
class SuspendableScheduler:
    ...
    async def run_turn(
        ...
        card_input = build_default_card_input(prompt)
...
__all__ = ["SuspendPoint", "SuspendableScheduler", "UserInput"]
