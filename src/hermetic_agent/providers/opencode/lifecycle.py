...
from hermetic_agent.providers.opencode.chat import get_client
from hermetic_agent.store.base import Session as StorageSession
...
async def _post_session_create_raw(
    ...
    *,
    ...
    """
    from hermetic_agent.providers.opencode.chat import _build_http_client
