...
字段填充规则:
- ``type = "BUSI_LOG_" + logSystemType.upper()``  (例 ``BUSI_LOG_hermetic_agent``)
...
from hermetic_agent.audit.log.log_context import get_request_id, get_request_time
...
_SKIP_MODULES = ("hermetic_agent.audit.log.",)
