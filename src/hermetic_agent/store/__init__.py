...
在启动期自动建表, 不再需要外部 ``docs/db/hermetic_agent-schema.sql`` 文件.
"""

from hermetic_agent.store import dto, models, repositories, services
from hermetic_agent.store.base import (
...
from hermetic_agent.store.memory import MemorySessionRepository as LegacyMemorySessionRepository
from hermetic_agent.store.memory import MemoryStorage
from hermetic_agent.store.mysql import MySQLStorage
from hermetic_agent.store.mysql import MySQLStorage as LegacyMySQLSessionRepository
from hermetic_agent.store.postgres import PostgresSessionRepository as LegacyPostgresSessionRepository
from hermetic_agent.store.postgres import PostgresStorage
...
from hermetic_agent.store.services import (
    AuditLogService,
    ChatTurnService,
    MessageService,
    PartService,
