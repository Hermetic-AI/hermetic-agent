...
不放在这里的东西:
  - controller 实现 (见 hermetic_agent.api.http.controllers)
  - 中间件 / ScenarioMiddleware 挂载 (见 hermetic_agent.api.http.app, 内部用)
  - Pydantic schema (见 hermetic_agent.api.http.schemas)
  - readiness / 启动期 scenario 加载 (见 hermetic_agent.api.lifecycle)
"""
