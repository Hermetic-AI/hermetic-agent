...
不放在这里的东西:
  - app 工厂 (见 hermetic_agent.api.app)
  - 任何 controller / HTTP routing (见 hermetic_agent.api.http)
...
from hermetic_agent.api.lifecycle.scenario_lifecycle import find_project_root, init_scenarios
