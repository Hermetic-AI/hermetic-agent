...
from openagent.api.lifecycle.scenario_lifecycle import find_project_root
from openagent.api.lifecycle.scenario_models import (
...
async def register_scenario(request: Request) -> JSONResponse:
    ...
    try:
        from openagent.scenarios.loader import _validate_resources  # type: ignore
