...
from openagent.audit.log.busi_logger import BusiLogger
from openagent.audit.log.dto import BusiLog
from openagent.audit.log.log_compress import maybe_compress
from openagent.audit.log.log_context import get_is_log, get_request_id, get_request_time
...
def _get_processor_logger() -> BusiLogger | None:
    ...
    with _processor_lock:
        ...
        try:
            _processor_logger = init_busi_logger("openagent")
        except Exception:
            return None
    return _processor_logger
